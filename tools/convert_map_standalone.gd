...
## Standalone map conversion script.
## Run with: godot --path <project> --headless --script res://tools/convert_map_standalone.gd
##
...
func _init():
	print("=== Map Conversion Pipeline (standalone) ===")
